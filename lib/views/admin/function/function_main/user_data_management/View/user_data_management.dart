...
import 'package:rock_classifier/Views/admin/function/function_main/user_data_management/View/utils_management.dart';
                                            ...
                                            onTap: () {
                                              if (currentUserRole == 'Super-User' && user.role == 'Admin') {
                                                ...
                                                ScaffoldMessenger.of(context).showSnackBar(
                                                  SnackBar(
                                                    content: Text("Bạn không có quyền chỉnh sửa người dùng này", style: GoogleFonts.poppins()),
                                          ...
                                          ListTile(
                                            ...
                                            onTap: () {
                                              if (currentUserRole == 'Super-User' && user.role == 'Admin') {
                                                ...
                                                ScaffoldMessenger.of(context).showSnackBar(
                                                  SnackBar(
                                                    content: Text("Bạn không có quyền xóa người dùng này", style: GoogleFonts.poppins()),
                                                    backgroundColor: Colors.redAccent,
                                                  ),
                                                );
                                              }
                  ...
                  GestureDetector(
                    ...
                    onTapUp: (_) async {
                      ...
                      if (fullNameController.text.isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text("Vui lòng nhập họ và tên", style: GoogleFonts.poppins()),
                            backgroundColor: Colors.redAccent,
                          ),
                        );
                        return;
                      ...
                      if (addressController.text.isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text("Vui lòng nhập địa chỉ", style: GoogleFonts.poppins()),
                            backgroundColor: Colors.redAccent,
                          ),
                        );
                        return;
                      ...
                      try {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text("Thêm người dùng thành công!", style: GoogleFonts.poppins()),
                            backgroundColor: const Color(0xFF3B82F6),
                          ),
                        );
                      } catch (e) {
